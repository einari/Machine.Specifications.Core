...
namespace Machine.Specifications.Factories
{
  public class BehaviorFactory
  {
    ...
    {
      var behaviorType = behaviorField.FieldType.GetTypeInfo().GetGenericArguments().First();
    ...
    {
      if (requiredField.FieldType.GetTypeInfo().IsAssignableFrom(contextField.FieldType))
      {
        return;
      }
