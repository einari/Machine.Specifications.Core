...
namespace Machine.Specifications.Utility
{
  public static class ReflectionHelper
  {
    ...
    {
      return
        type.GetTypeInfo().GetFields(BindingFlags.Instance | BindingFlags.DeclaredOnly | BindingFlags.NonPublic | BindingFlags.Public);
    }
    ...
    static AttributeFullName GetDelegateUsage(this FieldInfo fieldInfo)
    {
      ...
      var invoke = fieldType.GetTypeInfo().GetMethod("Invoke");
      ...
      if (attributeFullName is BehaviorAttributeFullName)
      {
        ...
        if (fieldType.GetTypeInfo().GenericTypeArguments.Length != 1)
        {
          throw new InvalidOperationException(
