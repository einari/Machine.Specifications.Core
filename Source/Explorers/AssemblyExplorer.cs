  ...
  public class AssemblyExplorer
  {
    ...
    public IEnumerable<ICleanupAfterEveryContextInAssembly> FindAssemblyWideContextCleanupsIn(Assembly assembly)
    {
      return assembly.GetExportedTypes()
        .Where(x => x.GetTypeInfo().GetInterfaces().Contains(typeof(ICleanupAfterEveryContextInAssembly)))
    ...
    {
      return assembly.GetExportedTypes()
        .Where(x => x.GetTypeInfo().GetInterfaces().Contains(typeof(ISupplementSpecificationResults)))
    ...
    {
      return assembly.GetExportedTypes()
        .Where(x => x.GetTypeInfo().GetInterfaces().Contains(typeof(IAssemblyContext)))
