...
namespace Example.Random
{
  ...
  [Tags(tag.example)]
  public class context_with_trace_output
  {
    Establish context =
      () => Trace.WriteLine("Trace.WriteLine message in establish");

    Because of =
      () => Trace.WriteLine("Trace.WriteLine message in because");

    Cleanup after =
      () => Trace.WriteLine("Trace.WriteLine message in cleanup");

    It should_log_messages =
      () => Trace.WriteLine("Trace.WriteLine message in spec");

    It should_log_messages_also_for_the_nth_spec =
      () => Trace.WriteLine("Trace.WriteLine message in nth spec");
  }
